...
<?php $q=filter_input(INPUT_GET,"query",FILTER_SANITIZE_STRING); 
if($q!=null):
    $alias=null;
    ...
    endforeach; 
    if($alias==null): ?>
        <p><?php echo "SUPERHERO NOT FOUND"; ?></p>
    <?php else: ?>
        <h3><?php echo strtoupper($alias); ?></h3>
        <h4><?php echo " A.K.A. ".strtoupper($name); ?></h4>
